            ...
            <div className="flex items-center justify-between px-2">
              ...
              >
                ...
                <div className="flex flex-col">
                  <h1 className="text-white text-lg font-bold leading-tight group-hover:text-primary-new transition-colors">
                    Footbooking
                  </h1>
...
const NavItem = ({ to, icon, label, end, onClick }) => {
  return (
    ...
    >
      ...
      <p
        className={`text-sm ${label === "Tableau de bord" ? "font-bold" : "font-medium"}`}
      >
        {label}
      </p>
    </NavLink>
