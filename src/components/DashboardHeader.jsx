        ...
        <header className="w-full px-8 py-6 sticky top-0 z-10 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-sm border-b border-[#493622]">
            <div className="flex flex-wrap items-center justify-between gap-4 max-w-[1400px] mx-auto">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#cbad90] text-sm">Bienvenue, {profile?.name || "Propriétaire"}</p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button onClick={openCreateModal} className="flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full h-10 px-6 bg-[#f27f0d] text-[#231a10] text-sm font-bold shadow-[0_0_15px_rgba(242,127,13,0.3)] hover:shadow-[0_0_20px_rgba(242,127,13,0.5)] transition-all">
