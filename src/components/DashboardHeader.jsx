      ...
      <div className="flex items-center justify-between gap-4 max-w-[1400px] mx-auto">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h2 className="text-white text-xl md:text-3xl font-black tracking-tight leading-none md:leading-tight">
              Vue d'ensemble
            </h2>
            <p className="hidden md:block text-[#cbad90] text-sm">
              Bienvenue, {profile?.name || "Propriétaire"}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 md:gap-4">
            ...
            {showNotifs && (
              <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-20 sm:top-full mt-3 sm:mt-3 w-auto sm:w-80 bg-[#2c241b] border border-[#493622] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 z-[100]">
                <div className="p-4 border-b border-[#493622] flex justify-between items-center bg-[#231a10]/50">
                  ...
                  <span className="text-[#f27f0d] text-xs font-bold bg-[#f27f0d]/10 px-2 py-1 rounded-full">
                ...
                <div className="max-h-96 overflow-y-auto">
                  {notifications.length > 0 ? (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-[#cbad90] text-xs mt-1 line-clamp-2">
                              {notif.message}
                            </p>
                            <div className="flex items-center justify-between mt-2">
                              <span className="text-[#5d452b] text-[10px] font-bold uppercase">
                    ...
                    <div className="p-8 text-center">
                      <span className="material-symbols-outlined text-[#493622] text-4xl mb-2">
                        notifications_off
                      </span>
          ...
          <button
            ...
            className="flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full h-9 md:h-10 px-4 md:px-6 bg-[#f27f0d] text-[#231a10] text-xs md:text-sm font-bold shadow-[0_0_15px_rgba(242,127,13,0.3)] hover:shadow-[0_0_20px_rgba(242,127,13,0.5)] transition-all"
          >
