    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div className="p-5 flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-4 border-t border-[#493622] pt-4">
                                <div className="flex items-center gap-1.5">
                                    <span className="material-symbols-outlined text-[#f27f0d] text-[20px]">schedule</span>
                                    <span className="text-sm text-[#cbad90]">{field.hours}</span>
                                </div>
                                <div className="flex items-center gap-1.5">
                                    <span className="material-symbols-outlined text-[#f27f0d] text-[20px]">attach_money</span>
                                    <span className="text-sm text-[#cbad90]">{field.price}</span>
                                </div>
                            </div>
                            <div className="flex gap-3 mt-2">
                                <button onClick={() => openEditModal(field)} className="flex-1 py-2.5 rounded-xl bg-[#493622] text-[#cbad90] hover:text-white hover:bg-[#5d452b] font-medium transition-colors flex items-center justify-center gap-2">
                ...
                <button onClick={openCreateModal} className="group relative flex flex-col items-center justify-center gap-4 rounded-2xl border-2 border-dashed border-[#493622] bg-[#2c241b]/30 p-8 hover:bg-[#2c241b] hover:border-[#f27f0d] transition-all h-full min-h-[400px]">
                    ...
                    <div className="text-center">
                        <h4 className="text-lg font-bold text-white">Ajouter un nouveau terrain</h4>
                        <p className="text-sm text-[#cbad90]">Configurez les détails, tarifs et disponibilités</p>
                    </div>
                </button>
            </div>
        </div>
