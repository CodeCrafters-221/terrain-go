    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between px-2">
        ...
        <Link
          ...
          className="text-[#f27f0d] text-sm font-medium hover:underline"
        >
          Voir tout
        </Link>
      </div>
        ...
        {displayFields.map((field) => (
          ...
          >
            ...
            >
              {" "}
              <div
                className={`absolute top-3 right-3 text-[#231a10] text-xs font-bold px-3 py-1 rounded-full shadow-sm ${field.status === "Disponible" ? "bg-[#0bda16]" : "bg-[#f27f0d]"}`}
              >
                {field.status}
              </div>
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-4 mt-1 border-t border-[#493622] pt-3">
                <div className="flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-[#f27f0d] text-[18px]">
                    schedule
                  </span>
